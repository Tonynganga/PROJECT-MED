...
class Blog_serializer(serializers.ModelSerializer):
    ...
    blogger_username=serializers.CharField(source='blogger_account.username')
    class Meta:
        model=Blogs
...
class Comment_serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields=['id','date_posted','commentor_profile_pic','commentor_first_name','commentor_last_name','commentor_username']
